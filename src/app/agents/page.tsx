      ...
      <div className="x9-card" style={{
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: 14, minWidth: 0 }}>
          ...
          <div style={{ minWidth: 0 }}>
            ...
            {agent.snsDomain && (
              <div style={{ fontSize: 11, color: 'var(--color-x9-accent)', marginTop: 1 }}>{agent.snsDomain}</div>
            )}
            {preview && (
              <div style={{ fontSize: 12, color: 'var(--color-x9-text-muted)', marginTop: 3, whiteSpace: 'nowrap', overflow: 'hidden', textOverflow: 'ellipsis', maxWidth: 380 }}>
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: 20, flexShrink: 0 }}>
          ...
          {agent.metaplexNftAddress && agent.metaplexNftAddress !== 'registration-pending' && (
            <div style={{ textAlign: 'right' }}>
              ...
              <div className="x9-mono" style={{ fontSize: 11, color: 'var(--color-x9-accent)' }}>{agent.metaplexNftAddress.slice(0, 6)}…</div>
            </div>
          )}
          <span style={{
